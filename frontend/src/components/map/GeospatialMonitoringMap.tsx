...
if (!layer) return;
  ...
  return (
    <div className="w-full h-full relative flex flex-col bg-[#08090B] font-sans select-none overflow-hidden rounded-2xl">
      {/* Top Map Control Bar */}
      <div className="bg-[#14181D]/90 border-b border-white/10 px-3 py-2 flex flex-wrap items-center justify-between gap-2 z-10 shadow-md font-mono text-xs backdrop-blur-md flex-shrink-0">
        {/* Region Filter Buttons */}
        <div className="flex items-center gap-1.5 bg-[#08090B] p-1 rounded-xl border border-white/10">
          <button
        ...
        <div className="flex items-center gap-1 bg-[#08090B] p-1 rounded-xl border border-white/10 shadow-inner">
          <button
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-[#08090B] border border-white/10 hover:border-[#FF7A18] text-gray-400 hover:text-white rounded-xl text-[11px] font-bold transition flex items-center gap-1 shadow-sm cursor-pointer"
      ...
      <div className="flex-1 w-full h-full relative">
        ...
        <div className="absolute bottom-3 right-3 z-[400] pointer-events-none">
          <div className="bg-[#14181D]/95 border border-white/15 rounded-2xl p-2.5 shadow-2xl backdrop-blur-md text-[10px] font-mono space-y-1.5 pointer-events-auto">
