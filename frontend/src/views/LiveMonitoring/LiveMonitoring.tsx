...
export const LiveMonitoring: React.FC<Props> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0 w-full bg-transparent overflow-y-auto overflow-x-hidden lg:overflow-hidden relative font-sans p-2.5 lg:p-3.5 pb-28 sm:pb-32 lg:pb-3.5 space-y-2.5 lg:space-y-3">
      ...
      <div className="flex-none lg:flex-1 grid grid-cols-1 lg:grid-cols-12 gap-3 lg:min-h-0 overflow-visible lg:overflow-hidden relative">
        {/* DOMINANT GIS MAP BENTO CARD */}
        <div className={`${isRightPanelOpen ? 'lg:col-span-8' : 'lg:col-span-12'} bento-card p-2 flex flex-col h-[480px] lg:h-full lg:min-h-0 overflow-hidden relative shadow-2xl flex-shrink-0 lg:flex-shrink transition-all duration-300`}>
        ...
        {/* RIGHT BENTO STACK */}
        {isRightPanelOpen && (
          <div className="lg:col-span-4 flex flex-col gap-3 h-auto lg:h-full lg:min-h-0 overflow-visible lg:overflow-hidden animate-in fade-in zoom-in duration-300">
          ...
          <div className="bento-card p-3 flex-1 flex flex-col overflow-hidden min-h-0 space-y-2">
            ...
            {/* Station List */}
            <div className="flex-1 overflow-y-auto h-[250px] lg:h-auto space-y-1.5 pr-0.5">
